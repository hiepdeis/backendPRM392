        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtpUsed = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskProjects_Users_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskProjectsId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskAssignees_TaskProjects_TaskProjectsId",
                        column: x => x.TaskProjectsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignees_TaskProjectsId",
                table: "TaskAssignees",
                column: "TaskProjectsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskProjects_CreatorId",
                table: "TaskProjects",
                column: "CreatorId");
